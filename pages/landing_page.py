...
class LandingPage(BasePage):
    ...
    def checking_logo_header_is_present_and_displayed(self):
        ...
        self.checking_is_element_present(LandingPageLocators.EXLAB_LOGO_HEADER, 'Logo', 'HEADER')
        self.checking_is_element_displayed(LandingPageLocators.EXLAB_LOGO_HEADER, 'Logo', 'HEADER')
        

    def checking_about_us_header_is_present_and_displayed(self):
        """Checking 'About_Us' button in HEADER is present and displayed"""

        self.checking_is_element_present(LandingPageLocators.ABOUT_US_HEADER_BUTTON, 'About_Us', 'HEADER')
        self.checking_is_element_displayed(LandingPageLocators.ABOUT_US_HEADER_BUTTON, 'About_Us', 'HEADER')
    ...
    def checking_projects_header_is_present_and_displayed(self):
        ...
        self.checking_is_element_present(LandingPageLocators.PROJECTS_HEADER_BUTTON, 'Projects', 'HEADER')
        self.checking_is_element_displayed(LandingPageLocators.PROJECTS_HEADER_BUTTON, 'Projects', 'HEADER')
    ...
    def checking_mentors_header_is_present_and_displayed(self):
        ...
        self.checking_is_element_present(LandingPageLocators.MENTORS_HEADER_BUTTON, 'Mentors', 'HEADER')
        self.checking_is_element_displayed(LandingPageLocators.MENTORS_HEADER_BUTTON, 'Mentors', 'HEADER')
    ...
    def checking_startup_for_header_is_present_and_displayed(self):
        ...
        self.checking_is_element_present(LandingPageLocators.STARTUP_FOR_HEADER_BUTTON, 'StartUp_For', 'HEADER')
        self.checking_is_element_displayed(LandingPageLocators.STARTUP_FOR_HEADER_BUTTON, 'StartUp_For', 'HEADER')
    ...
    def checking_sun_icon_header_is_present_and_displayed(self):
        ...
        self.checking_is_element_present(LandingPageLocators.SUN_ICON_HEADER_BUTTON, 'Sun_Icon', 'HEADER')
        self.checking_is_element_displayed(LandingPageLocators.SUN_ICON_HEADER_BUTTON, 'Sun_Icon', 'HEADER')
    ...
    def checking_join_header_is_present_and_displayed(self):
        ...
        self.checking_is_element_present(LandingPageLocators.JOIN_HEADER_BUTTON, 'Join', 'HEADER')
        self.checking_is_element_displayed(LandingPageLocators.JOIN_HEADER_BUTTON, 'Join', 'HEADER')
    ...
    def checking_logo_gif_in_your_opportunity_block_is_present_and_displayed(self):
        ...
        self.checking_is_element_present(LandingPageLocators.LOGO_YOUR_OPPORTUNITY, 'Logo_Gif', 'YOUR_OPPORTUNITY')
        self.checking_is_element_displayed(LandingPageLocators.LOGO_YOUR_OPPORTUNITY, 'Logo_Gif', 'YOUR_OPPORTUNITY')
    ...
    def checking_main_title_in_your_opportunity_block_is_present_and_displayed(self):
        ...
        self.checking_is_element_present(LandingPageLocators.MAIN_TITLE_YOUR_OPPROTUNITY, 'Main_Title', 'YOUR_OPPORTUNITY')
        self.checking_is_element_displayed(LandingPageLocators.MAIN_TITLE_YOUR_OPPROTUNITY, 'Main_Title', 'YOUR_OPPORTUNITY')
    ...
    def checking_text_under_main_title_in_your_opportunity_block_is_present_and_displayed(self):
        ...
        self.checking_is_element_present(LandingPageLocators.BLOCK_TEXT_YOUR_OPPORTUNITY, 'Text_Under_Main_Title', 'YOUR_OPPORTUNITY')
        self.checking_is_element_displayed(LandingPageLocators.BLOCK_TEXT_YOUR_OPPORTUNITY, 'Text_Under_Main_Title', 'YOUR_OPPORTUNITY')
    ...
    def checking_linkedin_footer_is_present_and_displayed(self):
        ...
        self.checking_is_element_present(LandingPageLocators.LINKEDIN_FOOTER, 'Linkedin', 'FOOTER')
        self.checking_is_element_displayed(LandingPageLocators.LINKEDIN_FOOTER, 'Linkedin', 'FOOTER')
    ...
    def checking_instagram_footer_is_present_and_displayed(self):
        ...
        self.checking_is_element_present(LandingPageLocators.INSTAGRAM_FOOTER, 'Instagram', 'FOOTER')
        self.checking_is_element_displayed(LandingPageLocators.INSTAGRAM_FOOTER, 'Instagram', 'FOOTER')
    ...
    def checking_telegram_footer_is_present_and_displayed(self):
        ...
        self.checking_is_element_present(LandingPageLocators.TELEGRAM_FOOTER, 'Telegram', 'FOOTER')
        self.checking_is_element_displayed(LandingPageLocators.TELEGRAM_FOOTER, 'Telegram', 'FOOTER')
    ...
    def checking_youtube_footer_is_present_and_displayed(self):
        ...
        self.checking_is_element_present(LandingPageLocators.YOUTUBE_FOOTER, 'Youtube', 'FOOTER')
        self.checking_is_element_displayed(LandingPageLocators.YOUTUBE_FOOTER, 'Youtube', 'FOOTER')
    ...
    def checking_join_why_exlab_is_present_and_displayed(self):
        ...
        self.checking_is_element_present(LandingPageLocators.JOIN_WHY_EXLAB_BLOCK, 'Join', 'Why_Exlab')
        self.checking_is_element_displayed(LandingPageLocators.JOIN_WHY_EXLAB_BLOCK, 'Join', 'Why_Exlab')
    ...
    def checking_boosty_help_project_button_is_present_and_displayed(self):
        ...
        self.checking_is_element_present(LandingPageLocators.BOOSTY_HELP_PROJECT_BUTTON, 'Boosty', 'Help_Project')
        self.checking_is_element_displayed(LandingPageLocators.BOOSTY_HELP_PROJECT_BUTTON, 'Boosty', 'Help_Project')
    ...
    def checking_patreon_help_project_button_is_present_and_displayed(self):
        ...
        self.checking_is_element_present(LandingPageLocators.PATREON_HELP_PROJECT_BUTTON, 'Patreon', 'Help_Project')
        self.checking_is_element_displayed(LandingPageLocators.PATREON_HELP_PROJECT_BUTTON, 'Patreon', 'Help_Project')
    ...
    def checking_main_title_about_us_is_present_and_displayed(self):
        ...
        self.checking_is_element_present(LandingPageLocators.MAIN_TITLE_ABOUT_US, 'About_Us_Title', 'About_Us')
        self.checking_is_element_displayed(LandingPageLocators.MAIN_TITLE_ABOUT_US, 'About_Us_Title', 'About_Us')
    ...
    def checking_description_about_us_is_present_and_displayed(self):
        ...
        self.checking_is_element_present(LandingPageLocators.DESCRIPTION_ABOUT_US, 'Description_About_Us', 'About_Us')
        self.checking_is_element_displayed(LandingPageLocators.DESCRIPTION_ABOUT_US, 'Description_About_Us', 'About_Us')
    ...
    def checking_why_exlab_title_why_exlab_is_present_and_displayed(self):
        ...
        self.checking_is_element_present(LandingPageLocators.MAIN_TITLE_WHY_EXLAB, 'Why_Exlab_Title', 'Why_Exlab')
        self.checking_is_element_displayed(LandingPageLocators.MAIN_TITLE_WHY_EXLAB, 'Why_Exlab_Title', 'Why_Exlab')
    ...
    def checking_description_why_exlab_is_present_and_displayed(self):
        ...
        self.checking_is_element_present(LandingPageLocators.DESCRIPTION_WHY_EXLAB, 'Description_Why_Exlab', 'Why_Exlab')
        self.checking_is_element_displayed(LandingPageLocators.DESCRIPTION_WHY_EXLAB, 'Description_Why_Exlab', 'Why_Exlab')
    ...
    def checking_projects_title_is_present_and_displayed(self):
        ...
        self.checking_is_element_present(LandingPageLocators.MAIN_TITLE_PROJECTS, 'Projects_Title', 'Projects')
        self.checking_is_element_displayed(LandingPageLocators.MAIN_TITLE_PROJECTS, 'Projects_Title', 'Projects')
    ...
    def checking_title_startup_for_is_present_and_displayed(self):
        ...
        self.checking_is_element_present(LandingPageLocators.MAIN_TITLE_STARTUP_FOR, 'StartUp_For_Title', 'StartUp_For')
        self.checking_is_element_displayed(LandingPageLocators.MAIN_TITLE_STARTUP_FOR, 'StartUp_For_Title', 'StartUp_For')
    ...
    def checking_descriptions_startup_for_is_present_and_displayed(self):
        ...
        self.checking_is_element_present(LandingPageLocators.JUNIORS_DESCRIPTION_STARTUP_FOR, 'Junior_Description', 'StartUp_For')
        self.checking_is_element_displayed(LandingPageLocators.JUNIORS_DESCRIPTION_STARTUP_FOR, 'Junior_Description', 'StartUp_For')
        ...
        self.checking_is_element_present(LandingPageLocators.RECRUTER_DESCRIPTIONS_STARTUP_FOR, 'Recruter_Description', 'StartUp_For')
        self.checking_is_element_displayed(LandingPageLocators.RECRUTER_DESCRIPTIONS_STARTUP_FOR, 'Recruter_Description', 'StartUp_For')
    ...
    def checking_title_help_project_is_present_and_displayed(self):
        ...
        self.checking_is_element_present(LandingPageLocators.TITLE_HELP_PROJECT, 'Help_Project_Title', 'Help_Project')
        self.checking_is_element_displayed(LandingPageLocators.TITLE_HELP_PROJECT, 'Help_Project_Title', 'Help_Project')
    ...
    def checking_description_help_project_is_present_and_displayed(self):
        ...
        self.checking_is_element_present(LandingPageLocators.DESCRIPTION_HELP_PROJECT, 'Description_Help_Project', 'Help_Project')
        self.checking_is_element_displayed(LandingPageLocators.DESCRIPTION_HELP_PROJECT, 'Description_Help_Project', 'Help_Project')
    ...
    def checking_title_stay_connected_is_present_and_displayed(self):
        ...
        self.checking_is_element_present(LandingPageLocators.STAY_CONNECTED_TITLE, 'Title_Stay_Connected', 'FOOTER')
        self.checking_is_element_displayed(LandingPageLocators.STAY_CONNECTED_TITLE, 'Title_Stay_Connected', 'FOOTER')
    ...
    def checking_description_stay_connected_is_present_and_displayed(self):
        ...
        self.checking_is_element_present(LandingPageLocators.DESCRIPTION_STAY_CONNECTED, 'Description_Stay_Connected', 'FOOTER')
        self.checking_is_element_displayed(LandingPageLocators.DESCRIPTION_STAY_CONNECTED, 'Description_Stay_Connected', 'FOOTER')

    
    def checking_logo_footer_is_present_and_displayed(self):
        """Checking Logo in FOOTER block is present and displayed"""

        self.checking_is_element_present(LandingPageLocators.LOGO_FOOTER, 'Logo', 'FOOTER')
        self.checking_is_element_displayed(LandingPageLocators.LOGO_FOOTER, 'Logo', 'FOOTER')
    ...
    def checking_text_under_logo_footer_is_present_and_displayed(self):
        ...
        self.checking_is_element_present(LandingPageLocators.TEXT_UNDER_LOGO_FOOTER, 'Text_Under_Logo', 'FOOTER')
        self.checking_is_element_displayed(LandingPageLocators.TEXT_UNDER_LOGO_FOOTER, 'Text_Under_Logo', 'FOOTER')
    ...
    def checking_mail_address_footer_is_present_and_displayed(self):
        ...
        self.checking_is_element_present(LandingPageLocators.MAIL_ADDRESS_FOOTER, 'Mail_Address', 'FOOTER')
        self.checking_is_element_displayed(LandingPageLocators.MAIL_ADDRESS_FOOTER, 'Mail_Address', 'FOOTER')